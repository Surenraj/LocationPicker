...
import com.srdev.locationpicker.utils.CustomButton;
import com.srdev.locationpicker.utils.CustomTextView;
import com.srdev.locationpicker.utils.FetchAddressIntentService;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    CustomButton submitLocationButton;

    private static final String TAG = com.srdev.locationpicker.MapActivity.class.getSimpleName();
    ...
    private void submitResultLocation(){
        ...
        if (addressResultCode == SimplePlacePicker.FAILURE_RESULT || !isSupportedArea) {
            Toast.makeText(this, R.string.failed_select_location, Toast.LENGTH_SHORT).show();
        } else {
